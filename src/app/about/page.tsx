            ...
            <div className={styles.overlay}>
                <div className={styles.about}>
                    <div>
                        ...
                        <h1 className={styles.subheading}>Yusra Saleem</h1>
                        <h3 className={styles.thirdheading}>
                            And I&#39;m a
                            <span>
                            <Typewriter
                                strings="Full-Stack Developer.,Web Designer.,Frontend Developer.,UI/UX Designer.,Digital Marketer.,Social Media Manager."
                    ...
                    <div className={styles.profileContainer}>
                        <Image className={styles.profileImage} src="/profile.png" alt="Profile of Yusra Saleem" width={400} height={400} />
                    </div>
                </div>
